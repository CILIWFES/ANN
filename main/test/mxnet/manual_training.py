...
#         print('\n')
# mod.save_params("test")
# mod._symbol.save("test-sa")


net = mx.sym.load('test')
mod = mx.mod.Module(symbol=net)
mod.init_params(initializer=mx.init.Load("test"))

from collections import namedtuple

MyBatch = namedtuple('MyBatch', ['data', 'label'])
new_batch_size = 1
mod.bind(data_shapes=[{'data': (new_batch_size, 1, 28, 28)}])
