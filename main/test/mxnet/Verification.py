...
net1 = mx.sym.FullyConnected(net, num_hidden=10, name='fc')
net2 = mx.sym.FullyConnected(net, num_hidden=10, name='fc1')
net3 = mx.sym.FullyConnected(net, num_hidden=10, name='fc2')
net4 = mx.sym.FullyConnected(net, num_hidden=10, name='fc3')

fc2 = mx.symbol.Concat(*[net1, net2, net3, net4], dim=0)
label = mx.symbol.transpose(data=label)
label = mx.symbol.Reshape(data=label, target_shape=(0,))

net = mx.sym.SoftmaxOutput(fc2, name='softmax', label=label)
